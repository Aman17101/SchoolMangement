...
func (api ApiRouts)BookRouts(routes *gin.Engine) {
	// Define routes
...
// @Security ApiKeyAuth
func (api ApiRouts) CreateBook(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetBook(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetBooks(ctx *gin.Context) {
...
// @success 200 {array} model.Book
// @Security ApiKeyAuth
func (api ApiRouts) GetBooksByFilter(c *gin.Context) {
...
// @success 200 {object} model.Book
// @Security ApiKeyAuth
func (api ApiRouts) UpdateBook(c *gin.Context) {
...
// @param id path string true "Book ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeleteBook(c *gin.Context) {
