...
func (api ApiRouts)LabRouts(routes *gin.Engine) {
	// Define routes
...
// @Security ApiKeyAuth
func (api ApiRouts) CreateLab(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetLab(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetLabs(ctx *gin.Context) {
...
// @success 200 {array} model.Lab
// @Security ApiKeyAuth
func (api ApiRouts) GetLabsByFilter(c *gin.Context) {
...
// @success 200 {object} model.Lab
// @Security ApiKeyAuth
func (api ApiRouts) UpdateLab(c *gin.Context) {
...
// @param id path string true "Lab ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeleteLab(c *gin.Context) {
