...
func (api ApiRouts) ClassRouts(routes *gin.Engine) {
	// Define routes
	group := routes.Group("class")
	{
		...
		group.GET("/filter", api.GetClassByFilter)
...
// @Security ApiKeyAuth
func (api ApiRouts) CreateClass(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetClass(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetClasss(ctx *gin.Context) {
...
// @success 200 {array} model.Class
// @Security ApiKeyAuth
func (api ApiRouts) GetClassByFilter(c *gin.Context) {
...
// @success 200 {object} model.Class
// @Security ApiKeyAuth
func (api ApiRouts) UpdateClass(c *gin.Context) {
...
// @param id path string true "Class ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeleteClass(c *gin.Context) {
