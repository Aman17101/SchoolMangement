...
func (api ApiRouts) TeacherRouts(routes *gin.Engine) {
	// Define routes
...
// @Security ApiKeyAuth
func (api ApiRouts) CreateTeacher(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetTeacher(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetTeachers(ctx *gin.Context) {
...
// @success 200 {array} model.Teacher
// @Security ApiKeyAuth
func (api ApiRouts) GetTeachersByFilter(c *gin.Context) {
...
// @success 200 {object} model.Teacher
// @Security ApiKeyAuth
func (api ApiRouts) UpdateTeacher(c *gin.Context) {
...
// @param id path string true "Teacher ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeleteTeacher(c *gin.Context) {
