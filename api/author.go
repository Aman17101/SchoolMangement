...
func (api ApiRouts) AuthorRouts(routes *gin.Engine) {
	// Define routes
...
// @Security ApiKeyAuth
func (api ApiRouts) CreateAuthor(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetAuthor(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetAuthors(ctx *gin.Context) {
...
// @success 200 {array} model.Author
// @Security ApiKeyAuth
func (api ApiRouts) GetAuthorsByFilter(c *gin.Context) {
...
// @success 200 {object} model.Author
// @Security ApiKeyAuth
func (api ApiRouts) UpdateAuthor(c *gin.Context) {
...
// @param id path string true "Author ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeleteAuthor(c *gin.Context) {
