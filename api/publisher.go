...
func (api ApiRouts) PublisherRouts(routes *gin.Engine) {
	// Define routes
...
// @Security ApiKeyAuth
func (api ApiRouts) CreatePublisher(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetPublisher(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetPublishers(ctx *gin.Context) {
...
// @success 200 {array} model.Publisher
// @Security ApiKeyAuth
func (api ApiRouts) GetPublishersByFilter(c *gin.Context) {
...
// @success 200 {object} model.Publisher
// @Security ApiKeyAuth
func (api ApiRouts) UpdatePublisher(c *gin.Context) {
...
// @param id path string true "Publisher ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeletePublisher(c *gin.Context) {
