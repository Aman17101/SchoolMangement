...
func (api ApiRouts)RoomRouts(routes *gin.Engine) {
	// Define routes
...
// @Security ApiKeyAuth
func (api ApiRouts) CreateRoom(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetRoom(ctx *gin.Context) {
...
// @Security ApiKeyAuth
func (api ApiRouts) GetRooms(ctx *gin.Context) {
...
// @success 200 {array} model.Room
// @Security ApiKeyAuth
func (api ApiRouts) GetRoomsByFilter(c *gin.Context) {
...
// @success 200 {object} model.Room
// @Security ApiKeyAuth
func (api ApiRouts) UpdateRoom(c *gin.Context) {
...
// @param id path string true "Room ID"
// @Security ApiKeyAuth
func (api ApiRouts) DeleteRoom(c *gin.Context) {
